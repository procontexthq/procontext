...
- **Improved MCP tool descriptions for better agent navigation** — restructured
  all tool descriptions with clear section headers (WHEN TO USE, HOW TO USE,
  INSTRUCTIONS, RESPONSE). Server instructions now include an explicit workflow,
  tool list, caching notes, and restrictions. `read_page` emphasizes reading the
  index first, and `search_page` provides specific guidance for index and
  full_docs_url searches.
...
[Unreleased]: https://github.com/procontexthq/procontext/compare/v0.2.3...HEAD
[0.2.3]: https://github.com/procontexthq/procontext/compare/v0.2.2...v0.2.3
